...
from .views import (create_doctor_view,doctor_list_view,specialization_view\
    ,patients_list_view,edit_specialization_view,\
    delete_specialization_view,doctors_view,patience_book_appointment,patient_pick_cat,\
    pentience_appointment_list_view,\
    doctor_view_patirnt_appointment,\
    doctor_view_app_id,rep_view,doctor_view_app_declined,\
    view_accepted_appointment_list,doctors_list_declined,doctors_manage_patient\
    ,delete_doctors_manage_patient,admin_declined_appointment_list_view,\
    create_pham_view\
    ,displays_pharmacy_to_admin,pentience_send_view\
    ,pentience_view_prescription,pentience_send_prescription_view\
    ,pentience_send_prescription_list,pharmacy_view_patient_prescription,
     pharmacy_view_id_patient,declined_drug_view,
     phar_view_approved_drug,phar_view_declined_drug,
     phar_display_pre_drug,prescription_update_pa,
...
urlpatterns = [
    ...
    #path('confirm-drug-view/<uuid:u_id>/',confirm_drug_view, name="confirm-drug-view"),
